...
interface ITaskStore {
    function addTask(address _from,address _to,uint8 _direction,uint256 _amount,bytes32 _txid,uint8 _voteNum)  external returns (bytes32 taskHash,bool isNewTask);
